         ...
         while(true){
            ...
            if(!msg.isEmpty() && msg != null) {
                ...
                if(EV.equals("1")  && !clientexist){
                	...
                	Document doc = new Document("FeedId", feedidIdnty[0])
                            .append("Vehicle_Speed", Vehichle_Speed)
                            .append("Engine_RPM", Engine_RPM)
                            .append("ThrottlePosition", ThrottlePosition)
                            .append("EngineLoad", EngineLoad)
                            .append("TimingAdvance", TimingAdvance)
                            .append("Accelerometer", Accelerometer)
                            .append("BatteryVoltage", BatteryVoltage)
                            .append("CPUTemperature", CPUTemperature);
